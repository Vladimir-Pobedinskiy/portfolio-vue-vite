...
const portfolio = {
	...
	portfolioList: [
		...
		},
		{
			...
			description:
				'Frontend-часть проекта разработана с использованием HTML, CSS и JavaScript в сочетании с Vue 3. Для сборки использовался Webpack, что обеспечило высокую производительность и масштабируемость приложения.',
