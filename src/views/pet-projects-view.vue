	...
	list: [
		{
			title: 'Список задач',
			description:
				'Это приложение представляет собой To-Do менеджер. Который включает добавление, удаление и редактирование задач, управление приоритетом и хэштегами. Приложение автоматически фиксирует время создания задачи. Для хранения данных используются Store, LocalStorage и Firestore, обеспечивая гибкость и надежность.',
			url: '/tasks',
		},
		{
			title: 'Герои',
		...
		{
			title: 'UI-компоненты',
			description: 'В данном блоке представлен набор UI-компонентов.',
			url: '/ui',
		},
	],
}
